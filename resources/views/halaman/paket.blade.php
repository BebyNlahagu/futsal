    ...
    <div class="container-xxl py-5">
        <div class="container">
            ...
            <form action="{{ route('halaman.paket') }}" method="GET" class="mb-4 text-center">
                ...
                <input type="date" id="tanggal_main" name="tanggal_main" value="{{ $tanggal_main }}"
                            ...
                            <table class="table table-hover table-bordered text-center align-middle">
                                ...
                                <tbody>
                                    @foreach ($jadwal as $j)
                                        <tr>
                                            <td>
                                                {{ \Carbon\Carbon::parse($j->star_time)->format('h:i A') }} -
                                                {{ \Carbon\Carbon::parse($j->star_time)->addHours($durasiUser)->format('h:i A') }}
                                            </td>
